...
class AssociadoFactory extends Factory
{
    ...
    {
        if (! self::$municipios) {
            self::$municipios = MunicipioService::all();
        }
        ...
        return [
            ...
            'cpf' => $this->faker->randomElement(['51430165090', '40175715068', '96251231050', '52067769049', '27250477064', '07186110045', '02185129023']),
            ...
            'naturalidade_uf' => $naturalidadeMunicipio->uf,
            'naturalidade_municipio_ibge' => $naturalidadeMunicipio->codigoIbge,
            'mae' => $this->faker->name(),
            'pai' => $this->faker->name(),
            ...
            'ocupacoes' => $this->faker->randomElements(['estudante', 'empresario', 'funcionario_publico', 'bancario', 'militar', 'autonomo', 'aposentado', 'pensionista', 'funcionario_privado', 'dono_de_casa', 'profissional_liberal', 'trabalhador']),
            ...
            'cep' => $this->faker->randomElement([47806421, 66010020, 66010060, 66010080, 66010051, 66023971, 66040281, 66073025]),
    ...
    public function selectRandomMunicipio(Collection $municipios): Municipio
    {
        return $municipios->random(1)->first();
    }
}
