...
class EditAtendimento extends EditRecord
{
    ...
    protected function getDescription(): string
    {
        ...
        $text .= "- Atendimentos referente à: <b>{$tiposAtendimento}</b> <br>\n";
    ...
    // {
    //     $path = 'atendimentos/pdfs/'.$this->record->id.'.pdf';

    //     $pdf = Pdf::loadView('declaracao-atendimento', ['atendimento' => $this->record]);
    //     $pdf->setPaper('a4', 'portrait');
