...
<body style="width: 388px;height: 244px; position: relative; background-size: cover; background-repeat: no-repeat;">
    <div
        style="position: absolute; bottom: 44px; left: -30px; font-size: 14px; font-family: sans-serif; line-height: 1.7;">
    ...
    @if (isset($carteirinha->shortUrl->default_short_url))
        <div style="position: absolute; right: 88px; top: 152px; width: 75px; height: 75px;">
            {{-- <p style="margin: 0; text-align: center;font-size: 10px;">
                <small><strong>QR Code</strong></small>
            </p> --}}
            <img style="width: 75px; height: 75px;" src="{{ $carteirinha->getQrCodeSvgUrl() }}">
            {{-- <p
