...
<body style="width: 388px;height: 244px; position: relative; background-size: cover; background-repeat: no-repeat;">
    <div style="position: absolute; bottom: 30px; left: -30px; font-size: 14px; font-family: sans-serif;">
    ...
    @if (isset($carteirinha->shortUrl->default_short_url))
        <div style="position: absolute; right: 105px; top: 136px; width: 85px; height: 85px;">
            {{-- <p style="margin: 0; text-align: center;font-size: 10px;">
                <small><strong>QR Code</strong></small>
            </p> --}}
            <img style="width: 85px; height: 85px;" src="{{ $carteirinha->getQrCodeSvgUrl() }}">
            {{-- <p
    ...
    @endif
    <div style="position: absolute; right: -5px;top: 127px;width: 88px;height: 101px; ">
