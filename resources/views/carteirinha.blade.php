...
<body style="width: 388px;height: 244px; position: relative; background-size: cover; background-repeat: no-repeat;">
    <div
        style="position: absolute; bottom: 44px; left: -35px; font-size: 12px; font-family: sans-serif; line-height: 1.5;">
    ...
    @endif
    <div style="position: absolute; right: 15px;top: 127px;width: 75px;height: 100px; ">
